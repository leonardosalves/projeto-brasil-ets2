...
#   --with-junction / --real-junction   -> usa traçado real + T-junction (prefab 56) no meio do trace (Fase de integração)
#   --junction-index N   (ou --junc N)  -> escolhe qual ponto do CSV será o centro da T-junction (padrão 5)
#   --side-length M      (ou --side M)  -> comprimento aproximado do acesso lateral (padrão 180)
